...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    //   new node.
    DListNode node = ((DList) this.myList).newNode(item, (DList) this.myList, this, this.next);
    this.next.prev = node;
    this.next = node;
    this.myList.size++;
  }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   what DList it's in.  You should use myList.newNode() to create the
    //   new node.
    DListNode node = ((DList)this.myList).newNode(item, (DList)this.myList, this.prev, this.next);
    this.prev.next = node;
    this.prev = node;
    this.myList.size++;
  }
