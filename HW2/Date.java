...
class Date {
  ...
  public Date(String s) {
    ...
    String day = date[1];
    String year = date[2];
    if(month.length() < 1 || month.length() > 2 || day.length() < 1 || day.length() > 2 || year.length() < 1 || year.length() > 4){
        System.exit(0);
    }
  ...
  public static void main(String[] argv) {
    ...
    System.out.println("2012 is a Leap year: " + isLeapYear(2012));
